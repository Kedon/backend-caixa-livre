...
router.post('/', controller.rateUser);
router.get('/:type', controller.ratingsReceived);
router.get('/sender/:type', controller.ratingsSubmitted);
router.get('/verify', controller.verifyRate);
